...
#include "Tlc5947.h"  //https://github.com/dochin/Tlc5947
...
void loop() {
    ...
    for (byte i=0; i < NUM_LEDS; i++) {
      myLedDriver.gsdata[i]=255; //assign a random grayscale value to each LED
    }
    ...
    for (byte i=0; i < NUM_LEDS; i++) {
      myLedDriver.gsdata[i]=0; //assign a random grayscale value to each LED
    }
